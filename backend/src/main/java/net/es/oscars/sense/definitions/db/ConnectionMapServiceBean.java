...
public class ConnectionMapServiceBean implements ConnectionMapService {
  ...
  public ConnectionMap get(long id) {
    return connectionMapRepository.findById(id).get();
  }
  ...
  public ConnectionMap store(ConnectionMap connectionMap) {
    if (Strings.isNullOrEmpty(connectionMap.getDescription()) || Strings.isNullOrEmpty(connectionMap.getDeltaId())
  ...
  public void delete(long id) {
    connectionMapRepository.deleteById(id);
  }
