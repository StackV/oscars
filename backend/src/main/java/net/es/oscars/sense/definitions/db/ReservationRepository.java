...
public interface ReservationRepository extends CrudRepository<Reservation, Long> {
         ...
         * @return
         */
        public Collection<Reservation> findByGlobalReservationId(
         ...
         * @return
         */
        public Reservation findByProviderNsaAndConnectionId(@Param("providerNsa") String providerNsa,
         ...
         * @return
         */
        public Collection<Reservation> findByProviderNsaAndParentConnectionId(@Param("providerNsa") String providerNsa,
         ...
         * @return
         */
        public Collection<Reservation> findByParentConnectionId(@Param("parentConnectionId") String parentConnectionId);
         ...
         * @return
         */
        public Collection<Reservation> findByProviderNsa(@Param("providerNsa") String providerNsa);
