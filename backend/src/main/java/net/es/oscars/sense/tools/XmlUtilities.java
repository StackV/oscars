...
public class XmlUtilities {
  ...
  /**
   * Utility method to marshal a JAXB annotated java object to an XML formatted
   * string. This class is generic enough to be used for any JAXB annotated java
   * object not containing the {@link XmlRootElement} annotation.
   *
