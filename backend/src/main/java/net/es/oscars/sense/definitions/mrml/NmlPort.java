...
// *
// * maximumReservableCapacity - the maximum amount of bandwidth that can be
// * reserved by circuits in bps. This is mapped to the MRML individualCapacity
// * attribute.
// *
// * minimumReservableCapacity - the minimum amount of bandwidth that can be
// * reserved by a circuit in bps. This is mapped to the MRML minimumCapacity
// * attribute.
// *
// * capacity - total bandwidth of the port in bps. This maps to the MRML
// * maximumCapacity attribute.
// *
// * granularity - the increments that bandwidth can be reserved by a circuit in
// * bps. This maps to the MRML granularity attribute.
// */
...
// // maximumCapacity - total port capacity (a guaranteed reservation could
// burst
// // up to this capacity).
// @Builder.Default
// private Optional<Long> maximumCapacity = Optional.empty(); // capacity

// // minimumCapacity - what is the smallest capacity reservation that could be
// // requested?
// @Builder.Default
// private Optional<Long> minimumCapacity = Optional.empty(); //
// minimumReservableCapacity

// // This is a temporal attribute identifying the amount of bandwidth consumed
// at
// // a point in time.
// @Builder.Default
// private Optional<Long> usedCapacity = Optional.empty(); // Need multiple
// BandwidthService elements to model temporal
// // values.

// // availableCapacity - the reservable capacity remaining on the port.
// // (calculation based on point in time)
// // availableCapacity = reservableCapacity - usedCapacity; (for each time
// slot)
// @Builder.Default
// private Optional<Long> availableCapacity = Optional.empty(); // Need multiple
// BandwidthService elements to model
// // temporal values.

// // reservableCapacity - max capacity allocated to this queue.
// @Builder.Default
// private Optional<Long> reservableCapacity = Optional.empty(); // Use capacity
// for now.

// // individualCapacity - per service maximum (a policy enforced maximum
// capacity
// // per service request).
// @Builder.Default
