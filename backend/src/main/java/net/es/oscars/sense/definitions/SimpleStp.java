...
public final class SimpleStp {
  ...
  /**
   * Return the STP identifier component consisting of the networkId and localId
   * portion.
   *
   * @return
   */
  ...
  /**
   * Perform an intersection of the labels within this STP with the Set of
   * provided labels.
   *
   * @param labels
  ...
  public int hashCode() {
    ...
    final int prime = 31;
    int result = 69;
    result = prime * result + ((thisStpId == null) ? 0 : thisStpId.hashCode());
    return result;
  }
}
