...
public class Reservation implements Serializable {
  public enum ErrorState {
    NONE, NSIRESERVEFAILED, NSIRESERVETIMEOUT, NSIRESERVECOMMIT, NSIPROVISION, NSITERMINATE, NSIERROR, NSIERROREVENT,
  ...
  public String toString() {
    return "Reservation{" + "id=" + id + ", discovered=" + discovered + ", providerNsa='" + providerNsa + '\''
        + ", globalReservationId='" + globalReservationId + '\'' + ", description='" + description + '\''
        + ", parentConnectionId='" + parentConnectionId + '\'' + ", connectionId='" + connectionId + '\''
        + ", topologyId='" + topologyId + '\'' + ", serviceType='" + serviceType + '\'' + ", startTime=" + startTime
        + ", endTime=" + endTime + ", reservationState=" + reservationState + ", provisionState=" + provisionState
        + ", lifecycleState=" + lifecycleState + ", dataPlaneActive=" + dataPlaneActive + ", version=" + version
        + ", errorState=" + errorState + ", errorMessage=" + errorMessage + ", service='" + service + '\'' + '}';
  }
  ...
  public boolean diff(Reservation r) {
    ...
    if (description != null && r.getDescription() != null && !description.equals(r.getDescription())) {
      return true;
    }
    ...
    if (connectionId != null && r.getConnectionId() != null && !connectionId.equals(r.getConnectionId())) {
      return true;
    }

    if (topologyId != null && r.getTopologyId() != null && !topologyId.equals(r.getTopologyId())) {
      return true;
    }

    if (serviceType != null && r.getServiceType() != null && !serviceType.equals(r.getServiceType())) {
      return true;
    }
    ...
    if (reservationState != r.getReservationState() || provisionState != r.getProvisionState()
        || lifecycleState != r.getLifecycleState() || dataPlaneActive != r.isDataPlaneActive()) {
      return true;
    }
