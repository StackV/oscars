...
public class NmlExistsDuring {
  ...
  /**
   * OpenNSA will not accept a starTime in the past so we want to give ourselves a
   * 60 second padding for a startTime in the future to account for delay in
   * propagation. If the specified startTime is in the past, or within 10 seconds
   * from now, we return a startTime of now just to be safe.
   *
   * @return
  ...
  private XMLGregorianCalendar getTime(Resource service, Property start2) throws DatatypeConfigurationException {
